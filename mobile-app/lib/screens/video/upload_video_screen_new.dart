  ...
  Future<void> _uploadVideo() async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        throw Exception(response['message'] ?? AppLocalizations.of(context).uploadFailedWithError);
      }
    } catch (e) {
      print('Error uploading video: $e');
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${AppLocalizations.of(context).uploadFailedWithError}: $e')),
        );
      }
    } finally {
      if (mounted) {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            '${AppLocalizations.of(context).uploadingProgress}... ${(_uploadProgress * 100).toStringAsFixed(0)}%',
        ...
        children: [
          ...
          Card(
            child: ListTile(
              ...
              title: Text(_thumbnailFile != null
                  ? AppLocalizations.of(context).thumbnailSelected
                  : AppLocalizations.of(context).selectThumbnailOptional),
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 16),
                    Text(AppLocalizations.of(context).generatingThumbnails),
                  ],
                ),
              ),
            ),
            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context).autoGeneratedThumbnails,
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    Text(
                      AppLocalizations.of(context).selectThumbnailOrUpload,
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                return AppLocalizations.of(context).enterTitleRequired;
              }
              return null;
            },
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              border: const OutlineInputBorder(),
              hintText: AppLocalizations.of(context).enterVideoDescription,
            ),
            maxLines: 3,
            enabled: !_isUploading,
          ),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              border: const OutlineInputBorder(),
              hintText: AppLocalizations.of(context).tagExamples,
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value != null && value.isNotEmpty) {
                ...
                if (cost == null || cost < 0) {
                  return AppLocalizations.of(context).validCostMessage;
                }
              }
              return null;
            },
