...
class _MoviePlayerScreenState extends ConsumerState<MoviePlayerScreen>
  ...
  Future<void> _showTracksSheet([BuildContext? sheetContext]) async {
    ...
    final externalSubtitles = _currentEpisode?.subtitles ?? const <Subtitle>[];
          ...
          builder: (context, scrollController) {
            return ListView(
              ...
              children: [
                ...
                ...uniqueSubtitleTracks.asMap().entries.map((entry) {
                  final idx = entry.key;
                  final t = entry.value;
                  final selected =
                ...
                if (externalSubtitles.isNotEmpty) ...[
                  ...
                  ...externalSubtitles.asMap().entries.map((entry) {
                    ...
                    return ListTile(
                      title: Text(sub.label.isNotEmpty ? sub.label : 'Subtitle ${idx + 1}'),
                      subtitle: Text(
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            ...
            // Back button (kept minimal; built-in controls handle playback UI).
            Positioned(
              top: 0,
              left: 0,
              child: SafeArea(
